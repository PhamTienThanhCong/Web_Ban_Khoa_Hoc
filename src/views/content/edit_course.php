...
<div class="sales-boxes">
  <div class="recent-sales box" style="width: 100%; display: block">
    ...
    <form class="new-couse" method="post" action="course_add.php" enctype="multipart/form-data">
  ...
  <div class="recent-sales box" style="width: 100%; display: block">
    ...
    <div class="sales-details">
      <form id="edit-lesson" method="POST" action="#" class="new-couse">
        ...
        <input name="name_lesson" type="text" placeholder="Nhập tên của khóa học" onchange="changeTitleLesson(event)" />
        <br />
        <label for="">Link của bài học</label>
        <input id="link-lesson" type="text" name="link" placeholder="Nhập link bài học" onchange="changeLink()" />
        <br />
        <label style="display: inline-block; width: 100px" for="">Thể loại link</label>
        ...
        <br />
        <textarea name="description-lesson" id="myTextareaLesson"></textarea>
        <button class="btnCreate">Thêm bài học mới</button>
        <button type="button" id="btnShowPreview" class="btnCreate" onclick="ShowPreviewLesson(event)">
          Xem bản demo
        </button>
      </form>
    </div>
  ...
  <div class="recent-sales box" style="width: 100%; display: block">
    ...
    <div class="sales-details" style="display: block">
      <div class="video-preview">
        <iframe id="video-lesson-preview" height="420" src="https://www.youtube.com/embed/X57xjcih8Hk"></iframe>
      </div>
...
<div class="sales-boxes" style="margin-top: 25px">
  <div class="recent-sales box" style="width: 100%; display: block">
    ...
    <div class="content">
      <div class="img-pre">
        <img id="img-preview" src="https://image.thanhnien.vn/w1024/Uploaded/2022/xdrkxrvekx/2021_10_12/picture1-3031.png" alt="" />
      </div>
      <br />
